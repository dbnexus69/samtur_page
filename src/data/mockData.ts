...
export const mockData: AppData = {
  ...
  clients: [
    ...
    { id: 13, firstName: 'Carlos Eduardo', lastName: 'Gomez', name: 'Carlos Eduardo Gomez', docType: 'CC', docNumber: '10101010', phone: '3000000001', email: 'carlos.gomez@email.com', birthDate: '1990-01-01', status: 'active', avatar: AVATARS_CLIENTS[12], registrationDate: '2025-08-01' },
    { id: 14, firstName: 'Maria Fernanda', lastName: 'Lopez', name: 'Maria Fernanda Lopez', docType: 'CC', docNumber: '20202020', phone: '3000000002', email: 'maria.lopez@email.com', birthDate: '1990-02-02', status: 'active', avatar: AVATARS_CLIENTS[13], registrationDate: '2025-08-02' },
    { id: 15, firstName: 'Pedro Antonio', lastName: 'Ruiz', name: 'Pedro Antonio Ruiz', docType: 'CC', docNumber: '30303030', phone: '3000000003', email: 'pedro.ruiz@email.com', birthDate: '1990-03-03', status: 'active', avatar: AVATARS_CLIENTS[14], registrationDate: '2025-08-03' },
    { id: 16, firstName: 'Lucia Daniela', lastName: 'Peña', name: 'Lucia Daniela Peña', docType: 'CC', docNumber: '40404040', phone: '3000000004', email: 'lucia.pena@email.com', birthDate: '1990-04-04', status: 'active', avatar: AVATARS_CLIENTS[15], registrationDate: '2025-08-04' },
    { id: 17, firstName: 'Andres Felipe', lastName: 'Castro', name: 'Andres Felipe Castro', docType: 'CC', docNumber: '50505050', phone: '3000000005', email: 'andres.castro@email.com', birthDate: '1990-05-05', status: 'active', avatar: AVATARS_CLIENTS[16], registrationDate: '2025-08-05' }
  ],
  sales: [
    ...
    { id: 2, clientId: 3, clientName: 'Laura Martinez', vendorId: 2, vendorName: 'Juan Perez', date: '2025-12-05', total: 1800000, status: 'abonado', paymentMethod: 'Credito', isCredit: true, creditPaidAmount: 500000, creditDueDate: '2026-05-10', observations: 'Vuelo Bogota-Medellin' },
    { id: 3, clientId: 5, clientName: 'Sofia Hernandez', vendorId: 3, vendorName: 'Maria Garcia', date: '2025-12-08', total: 3200000, status: 'pendiente', paymentMethod: 'Credito', isCredit: true, creditPaidAmount: 0, creditDueDate: '2026-04-15', observations: 'Crucero Caribbean' },
    ...
    { id: 5, clientId: 4, clientName: 'Miguel Angel Rodriguez', vendorId: 3, vendorName: 'Maria Garcia', date: '2025-12-12', total: 4500000, status: 'abonado', paymentMethod: 'Credito', isCredit: true, creditPaidAmount: 2000000, creditDueDate: '2026-06-20', observations: 'Paquete premium Punta Cana' },
    ...
    { id: 7, clientId: 7, clientName: 'Carmen Lopez', vendorId: 3, vendorName: 'Maria Garcia', date: '2025-12-18', total: 5500000, status: 'pendiente', paymentMethod: 'Credito', isCredit: true, creditPaidAmount: 0, creditDueDate: '2026-05-02', observations: 'Viaje luna de miel Europa' },
    ...
    { id: 10, clientId: 10, clientName: 'Fernando Morales', vendorId: 2, vendorName: 'Juan Perez', date: '2025-12-25', total: 1500000, status: 'pendiente', paymentMethod: 'Credito', isCredit: true, creditPaidAmount: 0, creditDueDate: '2026-04-01', observations: 'Vuelo internacional' }
  ],
  flights: [
